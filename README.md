...
2. **Compiler le projet avec:** g++ -std=c++17 -I/Library/Frameworks/SDL2.framework/Headers -F/Library/Frameworks -framework SDL2 main.cpp PlayerCar.cpp Road.cpp -o main
